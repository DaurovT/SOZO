...
for m in 000_init m7_buildings_rls m7_shutdown_exclusion m8_audit_actor_phone m9_identity m10_pricing m11_crm m12_orders m13_order_children m14_order_enums m15_masters m16_buildings m17_org_code; do
  printf '  %-24s ' "$m"
