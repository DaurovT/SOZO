...
const OPERATIONAL: SystemParam[] = [
  ...
  {
    num: 205,
    name: 'За сколько часов напоминать о деталях адреса',
    value: '4',
    levels: ['global'],
    usage:
      'Если клиент не заполнил подъезд, этаж и домофон (C-50), напоминание уходит за это время до окна визита. ' +
      'Позже — бесполезно: мастер уже выехал',
    tz: 'ТЗ §17.17, PRD-01 §5',
  },
  {
    num: 206,
    name: 'Через сколько дней касание «Как дела»',
    value: '10',
    levels: ['global'],
    usage:
      'Сервисное касание после закрытой заявки: «кондиционер работает нормально?». Подпадает под частотный потолок 203 ' +
      'и под маркетинговое согласие — операционных уведомлений не касается',
    tz: 'ТЗ §17.12',
  },
  {
    num: 207,
    name: 'За сколько дней предупреждать об окончании гарантии',
    value: '7',
    levels: ['global'],
    usage: 'Напоминание клиенту проверить работу, пока гарантия действует (срок гарантии — параметр 29)',
    tz: 'ТЗ §17.12',
  },
];
