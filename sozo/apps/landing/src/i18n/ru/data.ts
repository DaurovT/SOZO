...
export const data = {
  ...
  //
  // Подписи короче, чем названия в прайсе: на телефоне плитки стоят в две
  // колонки, и «Бытовая техника (мелкий ремонт)» в них уже не помещается.
  // Уточнение всё равно происходит в форме и в разговоре с диспетчером,
  // а обрезанное название на плитке не уточняет ничего.
